...
class PublicTransport:
    ...
    def _engine_power(self):
        return self.__engine_power

    @property
    def info(self):
        """
        Свойство, которое выводит на печать информацию о: марке, цвете, годе выпуска и мощности двигателя
...
class Bus(PublicTransport):
    ...
    def park(self):
        """
        Свойство, которое возвращать значение park
        :return: номер парка
        """
        return f'Парк приписки автобуса: {self.park}'
    ...
    def _fare(self):
        """
        Геттер _fire (стоимость проезда)
        """
        return self.__fare
