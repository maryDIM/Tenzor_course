...
def to_roman(val):
    ...
    """
    my_dict_hundreds = {0: '', 1: 'C', 2: 'CC', 3: 'CCC', 4: 'CD', 5: 'D', 6: 'DC', 7: 'DCC', 8: 'DCCC', 9: 'CM'}
    my_dict_tens = {0: '', 1: 'X', 2: 'XX', 3: 'XXX', 4: 'XL', 5: 'L', 6: 'LX', 7: 'LXX', 8: 'LXXX', 9: 'XC'}
    my_dict_num = {0: '', 1: 'I', 2: 'II', 3: 'III', 4: 'IV', 5: 'V', 6: 'VI', 7: 'VII', 8: 'VIII', 9: 'IX'}

    roman_str = 'M' * int(val // 1000) + my_dict_hundreds[int((val % 1000) // 100)] \
                + my_dict_tens[int((val % 1000) % 100) // 10] + my_dict_num[int((val % 1000) % 100) % 10]
