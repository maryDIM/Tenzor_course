...
def everything_for_your_cat(cats_data):
    """
    Oптимизация хранения данных
    :param cats_data: Список кортежей с данными о кошках и их владельцах
    :return: Строка с именем владельца и данными о всех его животных на одной строке, на новой строке следующий
    покупатель и все его питомцы и т.д.
    """
    new_dict = {}
    for i in cats_data:
        fio = i[2] + ' ' + i[3]
        if fio not in new_dict:
            new_dict[fio] = i[0] + ', ' + str(i[1])
        else:
            new_dict[fio] = new_dict[fio] + '; ' + i[0] + ', ' + str(i[1])
